...
<router-link :to="{ name: 'ShowTask', params: { id: user.id },props:{fname:user.fname} }"><svg class="w-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
